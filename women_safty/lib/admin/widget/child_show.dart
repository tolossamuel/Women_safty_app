...
class ChildShow extends StatefulWidget {
  final String parentEmail;
  final String childName;
  final String childEmail;
  final String childPhone;
 
  const ChildShow({super.key, required this.parentEmail, required this.childName, required this.childEmail, required this.childPhone});

  @override
  State<ChildShow> createState() => _ChildShowState();
}

class _ChildShowState extends State<ChildShow> {
  bool off = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Center(
            child: Customtext(text: widget.childName, color: Colors.black, size: 20, weight: FontWeight.bold),

          ),
          const SizedBox(
            height: 20,
          ),
          Customtext(text: 'Name : ${widget.childName}', color: Colors.black, size: 15, weight: FontWeight.bold),

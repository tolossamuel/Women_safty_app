          ...
          children: [
            ...
            chatsIcon(Icons.camera_alt, "Camera", () async {
              ...
              if (await Permission.camera.isGranted) {
                 // Set accessed to true if permission is already granted
                  await getImageFromCamera(); // Call the camera function
              } else {
                // If permission is not granted, request it
                PermissionStatus status = await Permission.camera.request();
                if (status.isGranted) {
                 // Set accessed to true if permission is granted after request
                  await getImageFromCamera(); // Call the camera function
                } else {
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                    content: Text("Permission denied"),
                  ));
                  // Keep accessed as false if permission is denied
                }
              }
            ...
            chatsIcon(Icons.insert_photo, "Photo", () async {
              if (await Permission.photos.isGranted || await Permission.storage.isGranted) {
                // Set accessed to true if permission is already granted
                await getImage(); // Call the function to get the image from the gallery
              } else {
                // If permission is not granted, request it

...
class MessagesText extends StatefulWidget {
  const MessagesText({super.key});

  @override
  State<MessagesText> createState() => _MessagesTextState();
}

class _MessagesTextState extends State<MessagesText> {
  @override
  Widget build(BuildContext context) {
    String childEmail = ModalRoute.of(context)!.settings.arguments as String;
    print(childEmail);
    print(EmailsText.emailText);
    return SafeArea(
        child: Scaffold(
      appBar: AppBar(
                      ...
                      if (state is MessagesLoadingState) {
                        ...
                        return BlocBuilder<AuthBloc, AuthState>(
                          builder: (context, users) {
                            final emial = EmailsText.emailText;
                            print(users);
                            print(111111111);
                            return Expanded(
      ...
      bottomNavigationBar: const BottomBar(indicatore: 2,),
    ));
  }
}
